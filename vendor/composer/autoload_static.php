...
class ComposerStaticInit3c6309cab5ec01d082af20e153363470
{
    ...
    public static $classMap = array (
        ...
        'Exception\\AmountNotAddedException' => __DIR__ . '/../..' . '/src/exception/AmountNotAddedException.php',
        'Exception\\AmountNotRemovedException' => __DIR__ . '/../..' . '/src/exception/AmountNotRemovedException.php',
        'Exception\\LogistSendMoneyException' => __DIR__ . '/../..' . '/src/exception/LogistSendMoneyException.php',
        'Exception\\TransactionFaultUnknownException' => __DIR__ . '/../..' . '/src/exception/TransactionFaultUnknownException.php',
        'Exception\\TransactionNotAuthenticatedException' => __DIR__ . '/../..' . '/src/exception/TransactionNotAuthenticatedException.php',
        'Exception\\UserHasNotEnoughBalanceException' => __DIR__ . '/../..' . '/src/exception/UserHasNotEnoughBalanceException.php',
        ...
        'Transaction\\Balance' => __DIR__ . '/../..' . '/src/transaction/Balance.php',
        'Transaction\\Business\\AddAmountToUser' => __DIR__ . '/../..' . '/src/transaction/business/AddAmountToUser.php',
        'Transaction\\Business\\CheckAuthenticatedService' => __DIR__ . '/../..' . '/src/transaction/business/CheckAuthenticatedService.php',
        'Transaction\\Business\\CheckUserHasEnoughBalance' => __DIR__ . '/../..' . '/src/transaction/business/CheckUserHasEnoughBalance.php',
        'Transaction\\Business\\GetUserBalance' => __DIR__ . '/../..' . '/src/transaction/business/GetUserBalance.php',
        'Transaction\\Business\\RemoveAmountFromUser' => __DIR__ . '/../..' . '/src/transaction/business/RemoveAmountFromUser.php',
        'Transaction\\Business\\SendMoneyToUser' => __DIR__ . '/../..' . '/src/transaction/business/SendMoneyToUser.php',
        'Transaction\\Repository\\AuthenticatedServiceConstants' => __DIR__ . '/../..' . '/src/transaction/repository/AuthenticatedServiceConstants.php',
        'Transaction\\Repository\\AuthenticatedServiceMock' => __DIR__ . '/../..' . '/src/transaction/repository/AuthenticatedServiceMock.php',
        'Transaction\\Repository\\BalanceRepositoryMock' => __DIR__ . '/../..' . '/src/transaction/repository/BalanceRepositoryMock.php',
        'Transaction\\Repository\\IAuthenticatedService' => __DIR__ . '/../..' . '/src/transaction/repository/IAuthenticatedService.php',
        'Transaction\\Repository\\IBalanceRepository' => __DIR__ . '/../..' . '/src/transaction/repository/IBalanceRepository.php',
        'User\\Business\\GetUserByEmail' => __DIR__ . '/../..' . '/src/user/business/GetUserByEmail.php',
        'User\\Business\\UserTypeFactory' => __DIR__ . '/../..' . '/src/user/business/UserTypeFactory.php',
        'User\\Client' => __DIR__ . '/../..' . '/src/user/Client.php',
        'User\\IUser' => __DIR__ . '/../..' . '/src/user/IUser.php',
        'User\\Logist' => __DIR__ . '/../..' . '/src/user/Logist.php',
        'User\\Repository\\CheckUniqueDocument' => __DIR__ . '/../..' . '/src/user/repository/CheckUniqueDocument.php',
        'User\\Repository\\CheckUniqueEmail' => __DIR__ . '/../..' . '/src/user/repository/CheckUniqueEmail.php',
        'User\\Repository\\IUserRepository' => __DIR__ . '/../..' . '/src/user/repository/IUserRepository.php',
        'User\\Repository\\SaveUser' => __DIR__ . '/../..' . '/src/user/repository/SaveUser.php',
        'User\\Repository\\UserRepositoryMock' => __DIR__ . '/../..' . '/src/user/repository/UserRepositoryMock.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit3c6309cab5ec01d082af20e153363470::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit3c6309cab5ec01d082af20e153363470::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit3c6309cab5ec01d082af20e153363470::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit3c6309cab5ec01d082af20e153363470::$classMap;
